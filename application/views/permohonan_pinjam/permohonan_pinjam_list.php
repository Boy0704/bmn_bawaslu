        ...
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('permohonan_pinjam/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('permohonan_pinjam'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
            ...
            foreach ($permohonan_pinjam_data as $permohonan_pinjam)
            {
                ?>
                <tr>
			...
			<td><?php echo $permohonan_pinjam->id_barang ?></td>
